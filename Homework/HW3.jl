...
# ╔═╡ 3e7bd078-4b4f-11eb-274f-bf191aba69e0
size(sample_freqs)
...
double_letters = alphabet[findall(!iszero,diag(sample_freq_matrix,0))]
...
# ╔═╡ 82519350-4b51-11eb-2e22-171427acedee
sum_col, sum_row = sum(sample_freq_matrix,dims=1),sum(sample_freq_matrix,dims=2)
...
function matrix_distance(A, B)
	sum((A.-B).^2) # do something with A .- B
end
...
# ╔═╡ d010ce9c-4b8a-11eb-1f67-d1a9d116530c
...
emma_count = word_counts(split(emma))["Emma"]
...
# ╔═╡ e4765648-4b8c-11eb-1c74-c5d69cd65133
samples.English
...
# ╔═╡ 1d7d3a36-4b58-11eb-2d13-65e68ee6746d
